...
export default function Layout() {
  ...
  const bottomPadding = insets.bottom > 0 ? insets.bottom + 5 : Platform.OS === "android" ? 20 : 10;
  return (
    <Tabs
      screenOptions={({ route }) => ({
        headerShown: false, // this hides ALL headers from tab screens
        tabBarActiveTintColor: "#1f87fc",
        tabBarInactiveTintColor: "#888",
        tabBarStyle: {
          backgroundColor: "#121212",
          borderTopWidth: 0,
          elevation: 0,
          height: 50 + bottomPadding, // Set explicit height
